...
Pulse offers five preview palettes: **1. Copper** (petrol/copper/teal), **2. Cobalt** (navy/periwinkle/ice), **3. Ember** (charcoal/amber/khaki), **4. Moss** (evergreen/citron/sage), and **5. Oxblood** (wine/rose/champagne). Palette buttons update the existing iframe via an origin-checked preview message, preserving unsaved text and motion. Studio disables this selector. The production bundle remains unchanged.
